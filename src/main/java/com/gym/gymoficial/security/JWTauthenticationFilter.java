...
public class JWTauthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public static final String TOKEN_PASSWORD = "10766f6b-c460-497d-b89b-dfee1875701c";
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        DataUserDetails dataUserDetails = (DataUserDetails) authResult.getPrincipal();

        String token = JWT.create()
                .withSubject(dataUserDetails.getUsername())
